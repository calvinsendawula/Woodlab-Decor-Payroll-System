						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">Allowance Details</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-success edit_allowances" type="button" data-id="<?php echo $row['id'] ?>" data-allowance="<?php echo $row['allowance'] ?>" data-description="<?php echo $row['description'] ?>" >Edit</button>
...
<script>
	...
	$('.delete_allowances').click(function(){
		_conf("Are you sure to delete this allowance?","delete_allowances",[$(this).attr('data-id')])
	})
