...
<nav id="sidebar" class='mx-lt-5' style="margin-top:-55px;background-color:black;">

		<div>
			<img src="assets/img/Logo.png" style="display:block;max-width:fit-content;max-height:200px;width:auto;height:auto;" title="Woodlab Decor Logo" alt="Woodlab Decor Logo">
		</div>
