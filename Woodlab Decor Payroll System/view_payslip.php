...
<div class="contriner-fluid">
	<div class="col-md-12">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<p><b>Days Absent : <?php echo $absent ?></b></p>
				<p><b>Undertime (mins) : <?php echo $late ?></b></p>
				<p><b>Total Allowance Amount : Kshs. <?php echo number_format($allowance_amount,2) ?></b></p>
				<p><b>Total Deduction Amount : Kshs. <?php echo number_format($deduction_amount,2) ?></b></p>
				<p><b>Net Pay : Kshs. <?php echo number_format($net,2) ?></b></p>
			</div>
		</div>
			...
			<div class="col-md-6">
				<div class="card">
					...
					<div class="card-body">
					    ...
					    <span class="badge badge-primary badge-pill"><?php echo("Kshs. "); echo number_format($val->amount,2) ?></span>
					  </li>
